import svgPaths from "./svg-ain8pn2akx";
...
export default function AuthorizedMobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Authorized mobile">
      <Footer />
      <ButtonGroup />
      <Container />
      <Container1 />
