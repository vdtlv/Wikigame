import svgPaths from "./svg-incp3x46ra";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center relative shrink-0 w-full" data-name="Text Content Heading">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-[rgba(255,255,255,0.7)] w-full">
        <p className="leading-[1.4]">Select two articles and launch a game</p>
      </div>
    </div>
  );
}
...
function Copy() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Copy">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_48_4215)" id="Copy">
          <path d={svgPaths.p1fdd4880} id="Icon" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
        <defs>
...
export default function HostPartyScreen() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Host party screen">
      <Footer />
      <Container />
      <Container1 />
      <Container2 />
