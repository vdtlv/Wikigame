import svgPaths from "./svg-y38dqasf5h";
...
function Container() {
  return (
    <div className="bg-black h-[960px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[960px] items-center p-[16px] relative w-full">
          <ContentContainer />
        </div>
      </div>
    </div>
