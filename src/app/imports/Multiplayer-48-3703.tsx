import svgPaths from "./svg-ac3qjatpcg";
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Text">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[16px] text-[rgba(255,255,255,0.7)] w-full">You (host) and Lena</p>
    </div>
  );
}
...
export default function Multiplayer() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Multiplayer">
      <Footer />
      <ButtonGroup />
      <Container />
      <Container1 />
