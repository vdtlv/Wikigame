import svgPaths from "./svg-ejoel7dvz4";
...
function Russia() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="russia">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="russia">
          <path d={svgPaths.p36661d40} fill="var(--fill-0, #CE2028)" id="Vector" />
          <path d={svgPaths.pc706b40} fill="var(--fill-0, #22408C)" id="Vector_2" />
          <path d={svgPaths.p1ad1c80} fill="var(--fill-0, #EEEEEE)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function Button1() {
  return (
    <div className="absolute left-[16px] rounded-[8px] top-1/2 translate-y-[-50%]" data-name="Button">
      <div className="box-border content-stretch flex gap-[8px] items-center justify-center overflow-clip px-[12px] py-[8px] relative rounded-[inherit]">
        <Russia />
      </div>
