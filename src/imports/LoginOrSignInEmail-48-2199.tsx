import svgPaths from "./svg-9p901sxooa";
...
function Footer() {
  return (
    <div className="bg-black h-[56px] relative shrink-0 w-[360px]" data-name="Footer">
      <LogoContainer />
      <LoginButton />
    </div>
  );
...
function InputContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Input Container">
      <ArticleSelector />
      <Button1 />
    </div>
  );
...
function Container() {
  return (
    <div className="bg-black box-border content-stretch flex flex-col gap-[10px] items-center px-[16px] py-[48px] relative shrink-0 w-[360px]" data-name="Container">
      <QuickPlayContainer1 />
    </div>
  );
}
